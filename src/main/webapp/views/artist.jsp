<%--@elvariable id="artistTabs" type="java.util.List<com.hicksteam.tab.db.gen.tables.pojos.Tab>"--%>
...
<section class="section">
    <div class="container">
        <div class="columns is-multiline is-centered">
            <div class="column">
                <h1 class="title">${param.artist}</h1>
                <table class="table is-narrow">
                    ...
                    <tbody>
                    <c:forEach var="tab" items="${artistTabs}" varStatus="loop">
                        <tr>
                            <td>${loop.count}.</td>
                            <td>${tab.artist}</td>
